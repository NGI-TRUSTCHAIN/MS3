...
import { AdapterArguments, AdapterError, CallInput, CompiledOutput, CompileInput, DeployedOutput, DeployInput, GenerateContractInput, IBaseContractHandler, NetworkConfig, SmartContractErrorCode } from "@m3s/smart-contract"
import CodeGenerator from "./helpers/generator.js";
import SolidityCompiler from "./helpers/compiler.js";
import EvmInteractor from "./helpers/interactor.js";
...
interface args extends AdapterArguments<IOpenZeppelinAdapterOptionsV1> { 
    name: string,
    version: string,
    options:IOpenZeppelinAdapterOptionsV1
} 
