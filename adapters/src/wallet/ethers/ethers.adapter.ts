...
import { WalletEvent, IEVMWallet, AssetBalance, GenericTransactionData, EIP712TypedData, EstimatedFeeData, AdapterArguments, AdapterError, NetworkConfig, WalletErrorCode } from "@m3s/wallet";
...
interface args extends AdapterArguments<IEthersWalletOptionsV1> {
  name: string,
  version: string,
  options: IEthersWalletOptionsV1
}
