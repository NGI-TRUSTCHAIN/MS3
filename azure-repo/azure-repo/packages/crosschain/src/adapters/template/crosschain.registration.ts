...
import { AdapterMetadata, getEnvironments, getRequirements, RuntimeEnvironment, getStaticCompatibilityMatrix, Ms3Modules } from '@m3s/shared';
import Joi from 'joi';
...
export { adapterMetadata as crossChainAdapterMetadata };
const compatibilityMatrix = getStaticCompatibilityMatrix(Ms3Modules.crosschain, 'crosschain-template', '1.0.0');
export { compatibilityMatrix as crossChainCompatibilityMatrix };
