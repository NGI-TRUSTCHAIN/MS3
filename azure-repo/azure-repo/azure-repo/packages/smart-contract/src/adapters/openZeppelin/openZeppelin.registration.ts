...
import { AdapterMetadata, getStaticCompatibilityMatrix, getEnvironments, getRequirements, RuntimeEnvironment, Capability, Ms3Modules } from '@m3s/shared';
...
export { adapterMetadata as openZeppelinAdapterMetadata };
const compatibilityMatrix = getStaticCompatibilityMatrix(Ms3Modules.smartcontract, 'openZeppelin', '1.0.0');
export { compatibilityMatrix as openZeppelinCompatibilityMatrix };