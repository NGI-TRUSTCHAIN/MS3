 ...
 */
export async function fetchChainListNetwork(networkIdentifier: string = 'sepolia'): Promise<any> {
 ...
 */
export async function getWorkingChainConfigAsync(networkIdentifier: string = 'sepolia'): Promise<any | null> {
