...
// import { BrowserProvider, ethers, JsonRpcProvider, TransactionReceipt } from "ethers";
...
//  */
//   private async getProvider(): Promise<JsonRpcProvider | BrowserProvider> {
//     // grab the raw EIP-1193 provider (if any)
//     const injected = this.web3auth?.provider as any;

//     // build a minimal NetworkConfig from your Web3Auth chainConfig
//     const cc = this.config.options.web3authConfig.chainConfig;
    

//     const netConf: NetworkConfig = {
//       chainId: cc.chainId,
//       rpcUrls: cc.rpcTarget ? [cc.rpcTarget] : [],
//       decimals : this.decimals,
//       name: cc.displayName as string,
//       displayName: cc.displayName as string,
//       blockExplorerUrl: cc.blockExplorerUrl,
//       ticker: cc.ticker,
//       tickerName: cc.tickerName
//     };

//     // delegate to the shared helper
//     return NetworkHelper
//       .getInstance()
//       .getProvider(injected ?? netConf, netConf.rpcUrls, netConf.chainId);
//   }
...
//       // if the user’s config didn’t carry it, fetch it once
//       ?? (await NetworkHelper.getInstance()
//         .getNetworkConfig(config.chainId))?.decimals
//       ?? this.decimals;
...
//       to: tx.to,
//       value: tx.value ? toWei(tx.value, this.decimals) : undefined, // ✅ FIX THIS LINE
...
//       chainId: tx.options?.chainId ? toBigInt(tx.options.chainId) : undefined, // Will be populated by signer
...
//         txRequest.gasLimit = toBigInt(21000);
//       } else {
...
//             txRequest.gasLimit = toBigInt(5000000); // 5M gas for deployments
...
//               txRequest.gasLimit = toBigInt(1000000); // 1M gas
...
//               txRequest.gasLimit = toBigInt(300000); // 300K gas  
