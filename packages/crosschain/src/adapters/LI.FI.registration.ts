...
import { AdapterMetadata, getEnvironments, getRequirements, RuntimeEnvironment, getStaticCompatibilityMatrix, Capability, Ms3Modules } from '@m3s/shared';
import Joi from 'joi';
...
export { adapterMetadata as liFiAdapterMetadata };
const compatibilityMatrix = getStaticCompatibilityMatrix(Ms3Modules.crosschain, 'lifi', '1.0.0');
export { compatibilityMatrix as liFiCompatibilityMatrix };
