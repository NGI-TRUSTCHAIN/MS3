...
document.addEventListener('DOMContentLoaded', () => {
  ...
  connectButton.addEventListener('click', async () => {
    try {
      log('Initializing ethers wallet...');
      ...
      log('ethers initialized. Requesting accounts...');
  ...
  signMsgButton.addEventListener('click', async () => {
    try {
      ...
      log('Signing message...');
      const message = 'Hello from ethers Integration Test';
  ...
  log('ethers integration test loaded');
});